...
import lessonRedirects from "../../data/lesson-redirects.json";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {prevLesson && videoId && (
          <Link href={lessonRedirects[prevLesson] || `/lessons/${prevLesson}`} className={styles.arrowLeft} aria-label="Previous">
        ...
        {nextLesson && videoId && (
          <Link href={lessonRedirects[nextLesson] || `/lessons/${nextLesson}`} className={styles.arrowRight} aria-label="Next">
